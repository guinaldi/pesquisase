    ...
    <script type="text/javascript">  
      $(document).ready(function () {  
        $('#menu1').click(function () {
          ...
          $('#locomocao').css('display', 'none');
        });             
        $('#menu2').click(function () {
          $('#graficos').css('visibility', 'visible');
          $('#faixaEtaria').css('display', 'none');
        ...
        $('#menu4').click(function () {
          ...
          $('#estadoCivil').css('display', 'none');
          $('#filhos').css('display', 'none');
          $('#resideFranca').css('display', 'block');
          $('#residenciaPropria').css('display', 'none');
          $('#quemMora').css('display', 'none');
          $('#composicaoFamiliar').css('display', 'none');
          $('#atividadeFamilia').css('display', 'none');
        ...
        $('#menu5').click(function () {
          ...
          $('#filhos').css('display', 'none');
          $('#resideFranca').css('display', 'none');
          $('#residenciaPropria').css('display', 'block');
          $('#quemMora').css('display', 'none');
          $('#composicaoFamiliar').css('display', 'none');
          $('#atividadeFamilia').css('display', 'none');
          $('#rendaFamiliar').css('display', 'none');
        ...
        $('#menu7').click(function () {
          ...
          $('#residenciaPropria').css('display', 'none');
          $('#quemMora').css('display', 'none');
          $('#composicaoFamiliar').css('display', 'block');
          $('#atividadeFamilia').css('display', 'none');
          $('#rendaFamiliar').css('display', 'none');
          $('#areaTrabalho').css('display', 'none');
          $('#vidaEscolar').css('display', 'none');
        ...
        $('#menu8').click(function () {
          ...
          $('#quemMora').css('display', 'none');
          $('#composicaoFamiliar').css('display', 'none');
          $('#atividadeFamilia').css('display', 'block');
          $('#rendaFamiliar').css('display', 'none');
          $('#areaTrabalho').css('display', 'none');
          $('#vidaEscolar').css('display', 'none');
          $('#conhecimentoInfo').css('display', 'none');
        ...
        $('#menu9').click(function () {
          ...
          $('#composicaoFamiliar').css('display', 'none');
          $('#atividadeFamilia').css('display', 'none');
          $('#rendaFamiliar').css('display', 'block');
          $('#areaTrabalho').css('display', 'none');
          $('#vidaEscolar').css('display', 'none');
          $('#conhecimentoInfo').css('display', 'none');
          $('#idiomas').css('display', 'none');
        ...
        $('#menu10').click(function () {
          ...
          $('#atividadeFamilia').css('display', 'none');
          $('#rendaFamiliar').css('display', 'none');
          $('#areaTrabalho').css('display', 'block');
          $('#vidaEscolar').css('display', 'none');
          $('#conhecimentoInfo').css('display', 'none');
          $('#idiomas').css('display', 'none');
          $('#deficiencia').css('display', 'none');
        ...
        $('#menu12').click(function () {
          ...
          $('#areaTrabalho').css('display', 'none');
          $('#vidaEscolar').css('display', 'none');
          $('#conhecimentoInfo').css('display', 'block');
          $('#idiomas').css('display', 'none');
          $('#deficiencia').css('display', 'none');
          $('#locomocao').css('display', 'none');
        });           
  ...
  <body style="background-color:white">
    <nav>
      ...
      <a id="menu15">Locomoção</a>
		...
		<div id="graficos" style="width:90%; margin-left:300px;margin-top:10%;position:fixed; visibility:hidden">      
        <div id="faixaEtaria" style="display:block;" height="450px" width="450px"></div>
        <div id="estadoCivil" style="display:block" height="450px" width="450px"></div>  
        <div id="filhos" style="display:block" height="450px" width="450px"></div>		
        <div id="resideFranca" style="display:block" height="450px" width="450px"></div>  
        <div id="residenciaPropria" style="display:block" height="450px" width="450px"></div>  
        <div id="quemMora" style="display:block" height="450px" width="450px"></div>  
        <div id="composicaoFamiliar" style="display:block" height="450px" width="450px"></div>  
        <div id="atividadeFamilia" style="display:block" height="450px" width="450px"></div>  
        <div id="rendaFamiliar" style="display:block" height="450px" width="450px"></div>  
        <div id="areaTrabalho" style="display:block" height="450px" width="450px"></div>  
        <div id="vidaEscolar" style="display:block" height="450px" width="450px"></div>  
        <div id="conhecimentoInfo" style="display:block" height="450px" width="450px"></div>  
        <div id="idiomas" style="display:block" height="450px" width="450px"></div>  
        <div id="deficiencia" style="display:block" height="450px" width="450px"></div>
        <div id="locomocao" style="display:block" height="450px" width="450px"></div>
    </div>
    <?php
